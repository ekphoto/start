...
*****************************************/
function kpm_no_date_post_info_filter($post_info) {
	if ( !is_page() ) {
...
*****************************************/
function kpm_custom_login_logo() {
	echo '<style type="text/css">
	.login h1 a { 
	background-image:url('. get_stylesheet_directory_uri() .'/images/wordpress-logo.png) !important;
...
Custom Colored Post
*****************************************/
function kpm_posts_status_color(){
	echo '<style>
	...
	.status-trash 	{ background:#FFCC99; }
	</style>';
}
/****************************************
Custom Mobile Menu
*****************************************/
function kpm_mobile_before_content_widget() {
/*	if ( is_page( 'Blog' ) ) {*/
		echo '<div class="mobile_menu">';
		dynamic_sidebar( 'mobile_menu' );
		echo '</div><!-- end .mobile_menu -->';
/*		}*/
}
/****************************************
Custom Footer
